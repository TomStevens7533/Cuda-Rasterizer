...
void Application::Update()
{
	...
	Input_Triangle tr;
	tr.vertices[0] = glm::vec3{ 0.f, 0.5f,	  -5.f };
	tr.vertices[1] = glm::vec3{ -.5f, -.5f, -5.f };
	tr.vertices[2] = glm::vec3{ .5f, -.5f,  -5.f };


	triangleVec.push_back(tr);

	glm::mat4x4 trans = glm::translate(glm::mat4(1), glm::vec3{-1,0, -1});
